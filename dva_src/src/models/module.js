...
export default {
  ...
  effects: {
    ...
    *fetch({ payload: { params } }, { call, put }) {  // eslint-disable-line
      ...
      const result = yield call(moduleService.getList, options);
    ...
    *getDetail({ payload }, { call, put }) {  // eslint-disable-line
      ...
      const result = yield call(moduleService.getDetail, payload);
      if (result && result.returnCode === '0' && result.returnValue) {
    ...
    *create({ payload: { params } }, { call, put }) {  // eslint-disable-line
      ...
      const result = yield call(moduleService.create, params);
      return result;
    },
    ...
    *update({ payload: { id, params } }, { call, put }) {  // eslint-disable-line
      ...
      const result = yield call(moduleService.update, id, params);
      return result;
    },
    ...
    *updateStatus({ payload }, { call, put }) {  // eslint-disable-line
      ...
      const result = yield call(moduleService.update, payload.id, options);
      return result;
    },
    ...
    *delete({ payload }, { call, put }) {  // eslint-disable-line
      ...
      const result = yield call(moduleService.deleteActivityModule, payload);
      return result;
    },
  },
